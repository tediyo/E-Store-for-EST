      ...
      `} style={{backgroundColor: '#000000'}}>
        <div className="flex flex-col h-full relative">
          ...
          <div className="flex-shrink-0 px-6 pt-8 pb-6">
            <div className="relative flex flex-col items-center justify-center h-48 overflow-hidden rounded-2xl border border-gray-700/50" style={{backgroundColor: '#000000'}}>
              {/* Background Pattern */}
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="relative mb-2">
                  <div className="w-32 h-32 bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-500 rounded-3xl flex items-center justify-center shadow-xl shadow-blue-500/25 mx-auto border-2 border-yellow-400">
                    {/* Logo Image */}
                    <img 
                      src="/esho.jpg"
                      alt="E Store Logo" 
                    ...
                    {/* Fallback Text Logo */}
                    <div className="w-28 h-28 bg-white rounded-2xl flex items-center justify-center shadow-lg hidden">
                  ...
                  {/* Glow Effect */}
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-500 rounded-3xl blur-lg opacity-20 animate-pulse"></div>
                </div>
